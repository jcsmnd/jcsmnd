...
<body>
<nav id="navbar" class="navbar fixed-top navbar-expand-lg navbar-dark bg-primary">
...
<div class="jumbotron text-center">
    ...
    <p><h4 class="hide">I'm Myungsik, web developer.</h4></p>
</div>
<div class="container">
    <div id="rotate" class="row text-center">
        <div class="col-sm-3">
            <a href="/blog" class="btn btn-primary btn-block" role="button" data-toggle="tooltip" data-placement="bottom" title="AWS VPC EC2(Windows Server 2016) => AWS LIGHTSAIL(Ubuntu Custom Server 18.04, wordpress - php 7, mysql 5.7)">WP Blog</a>
        </div>
        <div class="col-sm-3">
